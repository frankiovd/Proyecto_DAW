        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex space-x-8">
                    ...
                    <a href="seguimiento-entrenamientos.html" class="text-secondary hover:text-primary font-medium transition duration-300">Seguimiento</a>
                </div>
            ...
            <div id="mobile-menu" class="md:hidden hidden pb-4">
                ...
                <a href="seguimiento-entrenamientos.html" class="block py-2 text-secondary hover:text-primary font-medium">Seguimiento</a>
